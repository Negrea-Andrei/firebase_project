...
const Profile = () => {
  ...
  return (
    <>
      <h1 className="text-center" >The photographer</h1>
      ...
      <img style={{ borderRadius: "4px "}} src={currentUser?.photoURL} alt={currentUser?.displayName } width="150" height="150"/> 
        <ul className="list-group mx-5">
          ...
          <li className="list-group-item"><span className="fs-5 text-capitalize">email: </span>{currentUser.email.toLowerCase()}</li>
        </ul>
      </div>
    </>
  );
